...
* Mobile first, responsive layouts
    ...
    'data': [
        ...
        'data/job_data.xml',
        'data/job_email_templates.xml',
        'data/owms_data.xml',
        'data/owms_edition_data.xml',
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'odex_road_mechanic/static/src/css/road_mechanic_jobs.css',
            ...
            'odex_road_mechanic/static/src/js/road_mechanic_jobs.js',
        ],
        'web.assets_backend': [
